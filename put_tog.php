<?php
require './modelpuzzles/putitogether.php';
...
<html lang="en">
  ...
  <div id="put_tog" class="container" >
  		<div>
			<a class="pages" href="put_tog.php?page=<?php echo $prev; ?>#puzzles">&lt;prev puzzle set</a>&nbsp;|&nbsp;
			<a class="pages" href="put_tog.php?page=<?php echo $next; ?>#puzzles">next puzzle set&gt;</a>
