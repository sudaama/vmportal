<?php
require './modelpuzzles/tangrams.php';
...
<html lang="en">
  ...
  <body> 
    ...
    <div class="jumbotron">
      <div class="container">
        <h1 class="display-3">'Tangram' Puzzles</h1>
        <hr>
        <p>In this section you will find a collection of different 'tangram' puzzles. A Print 'n' Play PDF version of each puzzle is available. Have Fun!</p>
  ...
  <hr>
 	<h2 class="text-center">Coin Puzzles</h2>

  <div id="tan_puz" class="container" >
  		<div>
			<a class="pages" href="tan_puz.php?page=<?php echo $prev; ?>#puzzles">&lt;prev puzzle set</a>&nbsp;|&nbsp;
			<a class="pages" href="tan_puz.php?page=<?php echo $next; ?>#puzzles">next puzzle set&gt;</a>
