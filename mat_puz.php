<?php
require './modelpuzzles/matchsticks.php';
...
<html lang="en">
  ...
  <body> 
    ...
    <div class="jumbotron">
      <div class="container">
        <h1 class="display-3">'Matchstick' Puzzles</h1>
        <hr>
        <p>In this section you will find a collection of different 'matchstick' puzzles. A Print 'n' Play PDF version of each puzzle is available. Have Fun!</p>
  ...
  <hr>
 	<h2 class="text-center">Put It Together</h2>

  <div id="mat_puz" class="container" >
  		<div>
			<a class="pages" href="mat_puz.php?page=<?php echo $prev; ?>#puzzles">&lt;prev puzzle set</a>&nbsp;|&nbsp;
			<a class="pages" href="mat_puz.php?page=<?php echo $next; ?>#puzzles">next puzzle set&gt;</a>
